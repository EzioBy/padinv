...
if [[ $# -lt 4 ]]; then
    echo "This scripts launches a job of training a PadInv encoder for" \
         "StyleGAN2 on LSUN-Church, with generated image resolution at 256x256."
    echo
    ...
    echo
    echo "Example: $0 8 ~/data/church_train_lmdb ~/data/church_val_lmdb ~/data/stylegan2_church_256.pth"
    echo
    exit 0
fi
